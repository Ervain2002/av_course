...
class CarNavigationNode(Node): 
    ...
    def setup_initial_pose(self): 
        ...
        initial_pose.pose.pose.position.x = 3888.959 #esialgne koht x telg
        initial_pose.pose.pose.position.y = 73811.71 #esialgne koht y telg
    ...
    def setup_goals(self): 
        self.goal_poses = [ 
        {'x': 3792.88, 'y': 73760.67, 'xx': 0.0, 'yy': 0.0, 'zz': 0.24, 'w': 0.96}, # x: 3775.01 y:73721.3 w: 1
        {'x': 3757.13, 'y': 73688.57, 'xx': 0.0, 'yy': 0.0, 'zz': -0.97, 'w': 0.24}, # x:3819.57 y:73724.5 zz: 0.23 w:0.97
        {'x': 3851.15, 'y': 73841.00, 'xx': 0.0, 'yy': 0.0, 'zz': 0.24, 'w': 0.97}  # x: 3836.18 y 73765.1 zz:-0.51 w: 0.86
        ]
        time.sleep(5) 
        self.publish_goal() 
